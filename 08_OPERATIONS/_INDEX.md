...
Date: 2026-07-20
Supersedes: v2.0 — adds a governed home for the Zoom Summary Generator static artifact without treating Drive as source or runtime.
Sources: AI OS CLAUDE.md v4.5; workspace root CLAUDE.md v4.6; Decisions 071, 107 and 108; live Drive audit 2026-07-20.
...
| `06_TOOL_ARTIFACTS/` | CONTROLLED STATIC ARTIFACTS | Self-contained non-secret operational outputs; never source repository, live runtime or deployment proof |
...
7. Static artifacts require a registry/index and source/deployment verification before change or use. Generated version history is not source control.
